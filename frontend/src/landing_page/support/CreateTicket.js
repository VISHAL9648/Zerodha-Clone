    ...
    return (
        ...
        <div className="container">
            <div className="row p-3 mb-5">
                ...
                <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Non Resident Indian (NRI)
<br/>                </a>
            </div>
            <div className="col-4 mt-5 ">
                <p  className="fs-4"><i class="fa fa-address-book" aria-hidden="true"></i> Your Zerodha Account</p>
...
<br/>                </a>
            ...
            <div className="col-4 mt-5">
                <p className="fs-4"><i class="fa fa-briefcase" aria-hidden="true"></i>Funds</p>
            ...
            <div className="col-4 mt-5 ">
                <p  className="fs-4 "><i class="fa fa-circle-o-notch" aria-hidden="true"></i>Console</p>
...
<br/>                </a>
            ...
            <div className="col-4 mt-5 ">
                <p  className="fs-4 "><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Coin</p>
